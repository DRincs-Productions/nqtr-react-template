    ...
    return (
        <div className="absolute inset-0 pointer-events-none flex flex-col">
            ...
            <div className="flex-1 min-h-0 flex flex-row">
                <div className="flex-1 min-w-0 overflow-hidden self-end opacity-50 hover:opacity-100 transition-opacity">
                    <Rooms />
                </div>
                <div className="flex-none self-stretch opacity-50 hover:opacity-100 transition-opacity">
                    <Activities />
                </div>
            </div>
        </div>
