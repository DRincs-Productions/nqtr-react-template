import { saveCommitment, setFixedRoutine } from "@drincs/nqtr";
...
const aliceSleep = new Commitment("alice_sleep", alice, aliceRoom, {
    fromHour: 20,
    toHour: 10,
    image: "https://raw.githubusercontent.com/DRincs-Productions/NQTR-System/main/game/images/Alice/roomsleep0A.webp",
...
const aliceSmokes = new Commitment("alice_smokes", alice, terrace, {
    fromHour: 10,
    toHour: 20,
    image: "https://raw.githubusercontent.com/DRincs-Productions/NQTR-System/main/game/images/Alice/terrace0A.webp",
    icon: (commitment, props) => {
        return (
            <NavigationRoundIconButton
                disabled={commitment.disabled}
